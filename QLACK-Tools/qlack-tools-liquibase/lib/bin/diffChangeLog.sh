...
# A changelog file is generated by Liquibase even if no changes were detected. The contents of the
# generated file are inspected to see if it really contains changes or not.
