...
public class ClamAvUtil {
   ...
   */
  public static ClamAV getClamAvInstance(InetSocketAddress address, int timeout){
   ...
   */
  public static Socket getSocketInstance(String clamAvHost, int clamAvPort) throws IOException {
