...
public class ClamAvServiceImpl implements AvService {
  ...
  /**
   * Sends file data for scanning to an open socket of the ClamAV antivirus server instance as a
   * {@link ByteArrayInputStream}
   *
   * @param data a {@link java.lang.Byte} array containing file data to be scanned
   * @return {@link com.eurodyn.qlack.util.av.api.dto.VirusScanDTO} the scanning result
   */
  public VirusScanDTO virusScan(byte[] data) {
    ...
    InetSocketAddress clamAVAddress = new InetSocketAddress(properties.getClamAvHost(),
