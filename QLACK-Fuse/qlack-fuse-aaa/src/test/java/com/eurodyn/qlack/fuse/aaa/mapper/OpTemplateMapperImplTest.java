...
public class OpTemplateMapperImplTest {
    ...
    public void mapToDTOListNullTest() {
        List<OpTemplateDTO> opTemplateDTOS = opTemplateMapper.mapToDTO((List<OpTemplate>) null);
    ...
    public void mapToEntityListNullTest() {
        assertEquals(null, opTemplateMapper.mapToEntity((List<OpTemplateDTO>) null));
        List<OpTemplate> opTemplates = opTemplateMapper.mapToEntity((List<OpTemplateDTO>) null);
