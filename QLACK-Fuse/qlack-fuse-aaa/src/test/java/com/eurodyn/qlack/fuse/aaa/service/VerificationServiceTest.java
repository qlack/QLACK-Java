...
public class VerificationServiceTest {
  ...
  public void testCreateVerificationToken() {
    ...
    verificationService
      .createVerificationToken(userID, verificationToken.getExpiresOn());
  ...
  public void testVerifyToken() {
    ...
    String verifiedUserId = verificationService
      .verifyToken(verificationToken.getId());
  ...
  public void testDeleteExpired() {
    ...
    verify(verificationTokenRepository, times(1))
      .deleteByExpiresOnBefore(anyLong());
  }
  ...
  public void testGetTokenPayload() {
    when(verificationTokenRepository.findById(verificationToken.getId()))
      .thenReturn(Optional.of(verificationToken));
    String foundPayload = verificationService
      .getTokenPayload(verificationToken.getId());
  ...
  public void testGetTokenUser() {
    when(verificationTokenRepository.findById(verificationToken.getId()))
      .thenReturn(Optional.of(verificationToken));
    String foundUser = verificationService
      .getTokenUser(verificationToken.getId());
