...
/**
 * A Repository interface written for OpTemplate.The usage of it to define a
 * number of abstract crud methods.
 *
 * @author European Dynamics SA
 */
@Repository
public interface OpTemplateRepository extends
  AAARepository<OpTemplate, String> {
