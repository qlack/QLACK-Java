...
/** A simple DTO (Data Transfer Object) for UseGroupHasOperation. A class that contains
 * information about the operations that a user who belongs to a specific group name has
 *
