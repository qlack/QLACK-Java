...
/**
 * A Simple DTO (Data Transfer Object) that does not contain any business logic. The usage of it
 * is to save and retrieve data for @{@link UserHasOperationDTO} objects.
 *
