...
/**
 * This service provides methods related to the task/process variables of
 * Activiti.
 *
...
public class VariableService {
   ...
   */
  public Object getVariableInstance(String processInstanceId,
    String variableKey) {
    try {
  ...
  public void setVariableInstance(String processInstanceId, String variableKey,
    ...
    try {
      runtimeService
        .setVariableLocal(processInstanceId, variableKey, variableValue);
    } catch (ActivitiObjectNotFoundException e) {
      throw new QDoesNotExistException(
        "There is no instance process with id " + processInstanceId);
    }
