...
/**
 * This service provides methods related to the KnowledgeBase, KnowledgeBaseLibrary and KnowledgeBaseRule objects.
 *
...
@Transactional
@Log
public class KnowledgeBaseServiceDupli {
    ...
    public KnowledgeBaseServiceDupli(KnowledgeBaseMapper knowledgeBaseMapper, KnowledgeBaseRepository knowledgeBaseRepository) {
    ...
    public String createKnowledgeBase(List<byte[]> libraries, List<String> rules) {
        log.info("Creating new Knowledge Base with " + libraries.size() + " libraries and " + rules.size() + " rules.");
