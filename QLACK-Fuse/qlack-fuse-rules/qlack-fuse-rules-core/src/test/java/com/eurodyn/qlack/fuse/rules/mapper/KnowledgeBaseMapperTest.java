...
public class KnowledgeBaseMapperTest {
  ...
  public void mapToDTONullStateTest() {
    ...
    assertNull(knowledgeBaseMapper.mapToDTO(knowledgeBase).getState());
  }
  ...
  public void mapToEntityNullStateTest() {
    ...
    assertNull(knowledgeBaseMapper.mapToEntity(knowledgeBaseDTO).getState());
  }
