...
/**
 *  A class that is used to throw an Exception if anything wrong
 *  happens in lexicon yaml procedure
 *
...
public class LexiconYMLProcessingException extends QException {
  ...
  /** An abstract method that is used to throw an exception
   *  message if anything wrong happens to lexicon yaml procedure
   *
