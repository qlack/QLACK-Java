...
public interface TemplateRepository extends QlackBaseRepository<Template, String> {
  ...
  /** An abstract method declaration to find the name of the template
   *  specified by its name and the language locale
  ...
  /** An abstract method that is used to retrieve the name of the template by its name
   *  and the language id
