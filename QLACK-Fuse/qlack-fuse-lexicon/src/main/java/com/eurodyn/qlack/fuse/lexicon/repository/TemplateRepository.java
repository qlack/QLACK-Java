...
/**
 * A Template Repository interface that is used to define abstract methods for crud operations for
 * the Template entity.
 *
...
public interface TemplateRepository extends QlackBaseRepository<Template, String> {
  ...
  /**
   * An abstract method declaration to find the name of the template specified by its name and the
   * language locale
   *
   * @param templateName the template name
   * @param locale the locale of the language
   * @return the template filtering by its name and the locale code of the language
   */
  Template findByNameAndLanguageLocale(String templateName, String locale);

  /**
   * An abstract method that is used to retrieve the name of the template by its name and the
   * language id
   *
