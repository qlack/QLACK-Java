...
public interface LanguageRepository extends
  QlackBaseRepository<Language, String> {

  /**
   * A declared method that is used to retrieve the language according to its
   * locale
   *
  ...
  /**
   * A method that is used to retrieve a list of language with ascending order
   * and active status true
   *
   * @return a list of language objects that theirs status is active and the
