...
/**
 * A Repository interface for Language object that is used in order to declare abstract methods for
 * crud operations.
 *
...
public interface LanguageRepository extends QlackBaseRepository<Language, String> {
  ...
  /**
   * A method that is used to retrieve a list of language with ascending order and active status
   * true
   *
   * @return a list of language objects that theirs status is active and the results ordered by
   * ascending
   */
