...
public class KeyServiceTest {
  ...
  final private static String NEW_NAME = "ATTACHMENT_DESC_NEW";
  private static String UPDATED_TRANSLATION = "Add Attachment Description";
  @InjectMocks
  private KeyService keyService;
  final private KeyRepository keyRepository = mock(KeyRepository.class);
  ...
  final private GroupService groupService = mock(GroupService.class);
  @Spy
  ...
  public void testGetFindKeysNullKeyName() {
    ...
    List<KeyDTO> foundKeys = keyService.findKeys(criteria, false);
    foundKeys.forEach(Assertions::assertNull);
  }
