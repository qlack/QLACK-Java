...
/**
 * 22/01/2018 : The term query finds documents that contain the exact terms specified in the inverted index. In addition to the simple Query
 * Terms we search directly in the nested objects. This will additional return a inner_hits Object that contains the Id's for the matched
 * nested terms.Example:
 *
 * <pre>
 * new QueryTerms()
