...
/**
 * 23/01/2018 : A query performing a query string against ES. A query that uses a query parser in order to parse its content Multiple fields
 * can be specified. In addition to the simple Query String we search directly in the nested objects. This will additional return a
 * inner_hits Object that contains the Id's for the matched nested terms/objects.
 *
 * <pre>
