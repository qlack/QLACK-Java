...
public class CreateIndexRequestMapperTest {
  ...
  public void mapToNStringEntityCreateNullTest()
    ...
    NStringEntity result = createIndexRequestMapper.mapToNStringEntity((CreateIndexRequest) null);
    assertEquals(expectedContent, CharStreams.toString(new InputStreamReader(
        result.getContent(), Charsets.UTF_8)));
  }
  ...
  public void mapToNStringEntityCreateNullFieldsTest() {
    assertEquals(null, createIndexRequestMapper.createIndexRequestToIndex(null));
    assertEquals(null, createIndexRequestMapper.createIndexRequestToMyStop(null));
    assertEquals(null, createIndexRequestMapper.createIndexRequestToFilter(null));
    assertEquals(null, createIndexRequestMapper.createIndexRequestToAnalysis(null));
    assertEquals(null, createIndexRequestMapper.createIndexRequestToSettings(null));
  }

  @Test
  public void mapToNStringEntityUpdateTest() throws IOException {
    UpdateMappingRequest updateMappingRequest = initTestValues.updateMappingRequest();
    ...
    NStringEntity result = createIndexRequestMapper.mapToNStringEntity(updateMappingRequest);
    assertEquals(expectedContent, CharStreams.toString(new InputStreamReader(
        result.getContent(), Charsets.UTF_8)));
  }
