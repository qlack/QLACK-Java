...
public class JPAQueryUtil {
  ...
  private static final QNodeAttribute Q_NODE_ATTRIBUTE = new QNodeAttribute(
    "nodeAttribute");
  ...
  /**
   * Creates a new JPAQuery to retrieve the nodes (folder/file) which have a
   * required node attribute name.
   *
   ...
   */
  public static JPAQuery<Node> createJpaQueryForName(EntityManager em,
    String name,
    String parentNodeID) {
  ...
  /**
   * Creates a new JPAQuery to search all the nodes that their name is
   * contained in a list of strings.
   *
   * @param em the Entity Manager instance
